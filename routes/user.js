               ...
               db.query(sql14, function (err, data14) { 
                  ...
                  db.query(sql12, function (err, data12) {
                     ...
                     db.query(sql11, function (err, data11) {
                        ...
                        db.query(sql10, function (err, data10) {
                           var sql9 = "SELECT * FROM `ems`.`certificate_details` ;"
                           db.query(sql9, function (err, data9) {
...
exports.edit_mdmscand = function (req, res) {
  ...
  var student_code = post.student_code;
   ...
   var selected_category = post.selected_category;
   var willing_for_counciling = post.willing_for_counciling;
   console.log('admission:'+rank + rank_no + ar_no + total_mark +
      neet_mark +reg_no+ neet_roll_no + course + 
      admission_type + admission_quota + course_commencement + date_of_admission +
       date_of_allotment + selected_category + willing_for_counciling);
  ...
  var address_type = post.address_type;
   ...
   var amount_of_agreement= post.amount_of_agreement;
   var period_of_agreement = post.period_of_agreement;
   console.log(institute_name+college_post+amount_of_agreement+period_of_agreement);
   //academic details
   var mbbs_name= post.mbbs_name;
   var mbbs_place= post.mbbs_place;
   var mbbs_district = post.mbbs_district;
   ...
   var mdms_marks = post.mdms_marks;
   var neet_percentile =post.neet_percentile;
   console.log(mbbs_marks+pg_diplamo_marks+mdms_marks+neet_percentile);
   //bank details
   var account_no = post.account_no;
   var bank_name = post.bank_name;
   var branch_name = post.branch_name; 
   ...
   console.log(account_no+bank_name+branch_name+ifsc+micr+pan_no);
   ...
   var surety_one_address = post.surety_one_aadhaar;
   ...
   var surety_two_address = post.surety_two_aadhaar;
   ...
   var surety_three_address = post.surety_three_aadhaar;
   ...
   db.query(sql,function(){  
   var sql =`UPDATE ems.cand_institute_details_mdms SET institute_name='${institute_name}',college_post='${college_post}',amount_of_agreement ='${amount_of_agreement}',period_of_agreement='${period_of_agreement}',last_modified_time='${last_modified_time}' WHERE (cand_id ='${cand_id}')`;
   db.query(sql,function(){
