                                          ...
                                          switch (reports) {
                                            ...
                                            case "Relieving Letter":
                                              if (
                                                ...
                                                var sql_relieving = `SELECT * from ems.cand_relieving_details where cand_id in ('${rel_cand_id.join(
                                                  "','"
                                                )}')`;
                                              } else {
                                                var sql_admission = `SELECT * FROM ems.cand_admission_details where cand_id in ('${rel_cand_id}')`;
                                                var sql_relieving = `SELECT * from ems.cand_relieving_details where cand_id in ('${rel_cand_id}')`;
                                              }
                                              db.query(
                                                sql_admission,
                                                (err, data_admission) => {
